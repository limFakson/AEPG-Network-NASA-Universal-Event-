      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-orbitron font-bold text-gradient">NASA Fire Detection</h1>
          ...
          <div className="flex-1 flex flex-col lg:flex-row p-4 lg:p-6 space-y-4 lg:space-y-0 lg:space-x-6">
            ...
            >
              ...
              <div className="glass-panel-glow rounded-2xl p-6">
                <h3 className="text-lg font-orbitron font-semibold mb-4 text-gradient flex items-center">
                  <AlertTriangle className="w-5 h-5 mr-2 text-orange-400" />
                  Air Quality Impact
                </h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">AQI Impact</span>
                    <span 
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">High Confidence Fires</span>
                    <span className="text-lg font-semibold">{airQualityImpact.highConfidenceFires}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Total Detections</span>
                    <span className="text-lg font-semibold">{airQualityImpact.totalFires}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-panel-glow rounded-2xl p-6">
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto scrollbar-hide">
                  {fireData.slice(0, 5).map((fire, index) => (
                    <motion.div
                      key={fire.id}
                      className="glass-panel rounded-lg p-3 cursor-pointer hover:bg-white/5 transition-colors"
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-gray-400">{fire.confidence}%</span>
                      </div>
                ...
                <div className="space-y-4">
                  {powerData.slice(0, 3).map((data, index) => (
                    <div key={index} className="flex justify-between items-center">
                      <span className="text-gray-400 capitalize">{data.parameter.replace('_', ' ')}</span>
